    ...
    public class AudioPlayer : AudioPlayerAgent
    {
        ...
        private AudioTrack GetNextTrack()
        {
            ...
            AudioTrack track = new AudioTrack(
                new Uri("http://ice.somafm.com/indiepop?ext=.mp3"),
                "IndiePop", "Soma.fm", null, new Uri("http://somafm.com/img/indychick.jpg"), 
                "indiepop", EnabledPlayerControls.Pause); 
